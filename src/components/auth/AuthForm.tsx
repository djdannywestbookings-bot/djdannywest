...
import { signIn, signUp, signInWithGoogle, signInWithApple } from "@/app/auth/actions";
    ...
    >
      ...
      <div className="space-y-3">
        <button
          ...
          className="group flex w-full items-center justify-center gap-3 border border-line bg-cream/[0.02] px-6 py-3.5 font-sans text-[12px] uppercase tracking-[0.22em] text-cream transition hover:border-cream hover:bg-cream hover:text-night disabled:opacity-50"
        >
          <GoogleMark />
