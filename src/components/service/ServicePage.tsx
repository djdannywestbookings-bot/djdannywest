...
export type ServicePageProps = {
  /** e.g. "Wedding DJ", "Quinceañera DJ" */
  service: string;
  /** Big italic display word that anchors the hero — e.g. "Weddings.", "Quinces." */
  displayWord: string;
  /** Sub-eyebrow above the hero */
  eyebrow: string;
  /** One-line hero subhead */
  tagline: string;
  /** Long-form intro paragraph */
  intro: string;
  /** Three "what you get" columns */
  whatYouGet: { label: string; copy: string }[];
  /** Headline above the "what you get" — keep short */
  whatYouGetHeading: string;
  /** Notable rooms, clients, or venues for this service */
  proof: string[];
  /** Heading for the proof strip */
  proofHeading: string;
          ...
          <div className="md:col-span-9">
            ...
            <h1 className="font-display font-light leading-[0.86] tracking-[-0.04em] text-cream">
              <motion.span
                ...
                className="opsz-display block text-[18vw] italic md:text-[clamp(80px,10vw,160px)]"
              >
                {displayWord}
              </motion.span>
            </h1>
      ...
      <section className="relative overflow-hidden bg-night py-24 md:py-32">
        ...
        <div className="relative mx-auto max-w-[1100px] px-6 text-center md:px-12">
          ...
          <h2 className="opsz-display mt-6 font-display text-[56px] font-normal leading-[0.92] tracking-[-0.035em] text-cream md:text-[clamp(72px,8vw,128px)]">
            Book your <span className="italic">{displayWord.toLowerCase().replace(/\.$/, "")}</span>
          </h2>
          <p className="mx-auto mt-8 max-w-md font-sans text-[16px] leading-[1.65] text-cream/65">
            Bookings by inquiry. Send your date and details — I respond within 24 hours.
          </p>
          <a
            href="/book"
